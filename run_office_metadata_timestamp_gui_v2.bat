...
color A1
title Office_Metadata_Timestamp_GUI_v2
setlocal EnableExtensions EnableDelayedExpansion

echo +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
echo Office Metadata Timestamp GUI v2
...
set "SCRIPT=%~dp0office_metadata_timestamp_gui_v2.py"
if not exist "%SCRIPT%" (
...
if errorlevel 1 (
    ...
    echo Modern .docx/.xlsx/.pptx files do not need olefile.
    echo.
    set "INSTALL_OLEFILE="
